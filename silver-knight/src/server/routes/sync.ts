...
router.get('/config', requirePermission('settings'), asyncHandler(async (_req: Request, res: Response) => {
...
router.get('/status', requirePermission('settings'), asyncHandler(async (_req: Request, res: Response) => {
  const config = await syncService.getConfig()
  res.json({
...
router.get('/logs', requirePermission('settings'), asyncHandler(async (req: Request, res: Response) => {
